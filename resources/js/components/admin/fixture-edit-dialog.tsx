                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Goals in ET only. Leave blank if
                                            unused.
                                        </p>
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="grid gap-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <select
                                        ...
                                        defaultValue={
                                            fixture.resultDuration ?? ''
                                        }
                                        className={selectClassName}
                                    >
                                        {RESULT_DURATION_OPTIONS.map(
                                            (option) => (
                                                <option
                                                    key={
                                                        option.value || 'auto'
                                    ...
                                    <InputError
                                        message={errors.result_duration}
                                    />
                                </div>
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="grid gap-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Required for Last goal settlement.
                                        </p>
                                        <select
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <select
                                            ...
                                            defaultValue={
                                                fixture.highestBooking ?? ''
                                            }
                                            className={selectClassName}
                                        >
                                            {HIGHEST_BOOKING_OPTIONS.map(
                                                (option) => (
                                                    <option
                                                        key={
                                                            option.value ||
                            ...
                            <div className="flex items-start gap-3 rounded-lg border px-3 py-3">
                                ...
                                <div className="grid gap-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Score or void open markets for this
                                        fixture and award points immediately.
                                    </p>
                                </div>
                            </div>
                        )}
